...
export const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await axios.post(
      "https://dermstore-deploy.onrender.com/auth/signUp",
      formData
    );
    // console.log(user);
      ...
      <div id="container1">
        ...
        <div>
          <form onSubmit={handleSubmit}>
            <p id="with2">OR - Create an account</p>
            <div>
            ...
            <p className="ajeet">Must be a mixture of specific characters and a min of 8 characters</p>
            <div>
            ...
            <div>
              <p className="formptg">Phone Number</p>
              <input type="tel" onChange={handleChange} name="mobile" id="" />
            </div>
            <p className="ajeet">Please ensure you use the country prefix e.g. +1</p>
            <div>
              <p className="formptg">Referrer Code</p>
            ...
            <div>
              <div id="check1">
                ...
                <span>
                  <p id="paracheck">
                    Opt in for loyalty rewards
                  </p>
                </span>
              </div>
            </div>
            <input type="submit" value="CREATE ACCOUNT" id="submit" required />
            <p id="term"className="ajeet">
              By signing up, logging in, or continuing to share your information you are opting-in to our{" "}
