...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        SAVE 25% ON EMINENCE ORGANIC SKIN CARE WHEN YOU BUY 2 OR MORE PRODUCTS. ENDS 3/31. SHOP NOW
      </div>
          ...
          <div className="upper_navbar">
            ...
            >
              ...
              >
                ...
                <p style={{ marginTop: "12px" }}>SignIn</p>
              </Link>
              {showLoginDrop ? (
                isAuth ? (
                  <div class="OnloginDropdown">
                    ...
                    <Link to="/wishlist">Your Favorites</Link>
